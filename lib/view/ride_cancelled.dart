...
class RidesCancelledPage extends StatefulWidget {
  const RidesCancelledPage({Key key}) : super(key: key);
    ...
    return Container(
      child: Column(
        children: [
          ...
          Expanded(
              child: ListView(
            children: [buildRidesCompletedTable()],
          )),
        ],
      ),
    );
...
class MyData extends DataTableSource {
  final List<Map<String, dynamic>> data = List.generate(
      ...
      (index) => {
            ...
            "km": "300",
            "fare": "6000",
            "pickupdate": "31/12/2022 12:30 AM",
            "dropdate": "01/01/2023 07:45 AM"
          });
